...
export class Dropdown {
  ...
  private createDropdown(): void {
    ...
    this.dropdownElement.classList.add("dropdown-menu");
    ...
    this.options.forEach((option) => {
      ...
      item.addEventListener("mouseenter", () => {
        item.style.backgroundColor = "var(--color-menu-hover)";
    ...
    // 黑色
    this.dropdownElement.style.backdropFilter = "var(--dropdown-bdf)";
    this.dropdownElement.style.background = "var(--dropdown-bg)";
    this.dropdownElement.style.border = "var(--dropdown-border)";
    this.dropdownElement.style.boxShadow = "var(--dropdown-boxShadow)";
